...
public class Timeout<T> {
    ...
    private final static Logger log = Logger.getLogger(Timeout.class);
    ...
    /**
     * Function that gives the Callable services the a time limit to complete If it
     * does not complete in time it will call the backAction defined determined by
     * the annotation
     * 
    ...
    public T execute(Callable<T> callableService) {
        ...
        try {
            ...
            // TODO: considering supporting more than one backup - making this somewhat
            // recursive :/
